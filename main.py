...
# Create the number from 1-9 with 3 rows and 3 columns
...
count = 0
# Create the number 0 at row5 column1
...
Button(root, text="<-", width=3, height=2, command=lambda :backspace).grid(row=5, column=4)
root.mainloop()
